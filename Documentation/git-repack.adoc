...
--print-repack-events::
	With `--geometric`, print machine-readable lines describing packfile
	roll-ups. Each line has the form `repack <input-pack-hash>... into
	<output-pack-hash>...`. This option cannot be used when promisor packs
	would be repacked.
